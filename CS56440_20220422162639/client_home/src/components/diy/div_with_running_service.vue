<template>
	<div class="diy_details_box diy_div_with_running_service">
		<div class="warp">
			<div class="container">
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/with_running_service/set?with_running_service_id=' + _this.obj["with_running_service_id"], {
								praise_len
							}, (res) => {
								if(res.result){
